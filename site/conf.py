...
BLOG_AUTHOR = "Daniel Jensen"  # (translatable)
BLOG_TITLE = "dhjensen.dk"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://dhjensen.dk/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://dhjensen.dk/"
BLOG_EMAIL = "dhjen@outlook.com"
BLOG_DESCRIPTION = "This is my personal site and blog"  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        ("/categories/", "Tags"),
        ("/rss.xml", "RSS feed"),
        ((("https://linkedin.com/in/dhjensen", "Linkedin"),
          ("https://facebook.com/dhjensen", "Facebook"),
          ("https://github.com/dhjensen", "GitHub")), "Socials"),
        ((("https://www.favicon-generator.org/", "Favicon Generator"),
          ("https://getnikola.com/", "Nikola"),
          ("https://www.python.org/", "Python")), "Links"),
    ),
}
...
<noscript><p><img referrerpolicy="no-referrer-when-downgrade" src="//matomo.dhjensen.dk/matomo.php?idsite=1&amp;rec=1" style="border:0;" alt="" /></p></noscript>
<!-- End Matomo Code -->"""
